    ...
    try {
        ...
        if (slug) {
            ...
            container.innerHTML = `
                ...
                <div id="pagination-placeholder" class="d-flex justify-content-center align-items-center mt-5 w-100"></div>
            `;
                            ...
                            <div class="card h-100 shadow-sm border-0 rounded-3 overflow-hidden d-flex flex-column">
                                ...
                                <div class="card-body d-flex flex-column p-4">
                                    ...
                                    <h5 class="card-title fw-bold text-dark mb-2">
                                        <a href="${escapeHtml(blogSlug)}.html" class="text-dark text-decoration-none stretched-link">${escapeHtml(blogTitle)}</a>
                                    </h5>
            ...
            const renderPaginationControls = () => {
                ...
                // Smart Page Range (Catalog Style)
